...
const plants = [
  {
    "Number": 1,
    "sanskrit_name": "Apamarga",
    "Botanical name": "Achyranthes aspera L.",
    "English name": "Prickly chaff flower",
    "Malayalam Name": "Katalati കടലാടി",
    "Kannada Name": "Utrani ಉತ್ತರಾಣಿ",
    "Description": "Achyranthes aspera is an annual herb that can grow up to 1-2 meters in height. It has an erect, stout stem; simple, opposite, and oblong leaves; and small greenish flowers that form in axillary or terminal spikes. The seeds are encapsulated in a utricle, and the plant is distinguished by its rough texture.",
    "Geographical distribution": "It is distributed throughout the tropical world. It can be found in many places growing as an introduced species and a common weed. It is an invasive species in some areas, including many Pacific Islands environments.",
    "Chemical constituents": "Betaine, Achyranthine, Hentriacontane, Ecdysterone; achyranthes saponins A,B,C,D.",
    "Important Therapeutic use": "Apamarga is an excellent diuretic. Hence useful in dysuria, urinary retention, water retention and urinary stones; It helps to break down the kidney and bladder stones. This action is not only due to its diuretic action.",
    "Other medical uses": "Antihypertensive - to treat blood pressure\nAnti diabetic - to treat blood sugar\nAbortifacient - causing abortion\nDiuretic - to increase urine production\nPurgative - to loosen stool\nSpasmolytic - to relieve muscle stiffness Hypoglycemic - to decrease blood sugar\nAnti fungal - to treat fungal infection",
  ...
  {
    "Number": 2,
    "sanskrit_name": "Cluster fig",
    "Botanical name": "Ficus racemosa L",
    "English name": "Sadāphala",
    "Malayalam Name": "Atthi",
    "Kannada Name": "Atthimara",
    "Description": "Cluster fig trees can grow up to 25-30 meters in height. They have a wide canopy with large, spreading branches. The leaves are broad, ovate, and have a glossy appearance. The fruit is small, round, and turns from green to red or purple as it ripens.",
    "Geographical distribution": "It is predominantly found in South and Southeast Asia, notably in India, Sri Lanka, Bangladesh, and Malaysia, and extends to northern and eastern Australia, as well as parts of eastern and southern Africa",
    "Chemical constituents": "Leaves & Fruits- Gluacol\nFruits- B- Sitosterol, ceryl behenate, Lupeol, Friedelin",
    "Important Therapeutic use": "Cluster fig trees, belong to the Moraceae family. They are known for their unique fruiting habit; the fruits grow in clusters directly from the main trunk and larger branches of the tree, hence the name Cluster fig.",
    "Other medical uses": "For Using on the Skin:\n\nIt can help with pain, heal wounds, and reduce swelling.\nThe sap from the plant helps with swelling, wounds, and more.\nThe young leaves can be put on the skin to make it look better.\nBoiling the leaves in water makes a liquid that can clean wounds and help with mouth problems when used as a mouthwash.\nFor Taking by Mouth:\nDigestive System:\nIt can soak up substances in the stomach, calming an upset stomach.\nEating the ripe fruit might make worms grow in the intestines.\nBoiling the bark in water helps with bleeding from the rear end, trouble absorbing nutrients from food, and more. The sap is also good for young children to help prevent issues when they are getting new teeth.\nBlood System:\nThe bark and fruit help stop bleeding.\nReproductive System:\nA special treatment using the bark helps with excessive vaginal discharge, heavy menstrual bleeding, and bleeding at unexpected times. It's also good for keeping a pregnancy healthy and helping the baby grow. The sap helps prevent releasing too soon during sex.\nPeeing System:\nIt makes you pee less and is good for diabetes when using the bark or fruit.\nFor Heat-Related Problems:\nEating the ripe fruit is good for conditions that make you feel like you're burning up."
  },
  {
    "Number": 3,
    "sanskrit_name": "Flame of the Forest",
    "Botanical name": "Butea monosperma\n(Lam.) Kuntze",
    "English name": "Palasa",
    "Malayalam Name": "Chamata",
    "Kannada Name": "Muttagamara",
    "Description": "Butea monosperma can grow up to 15 meters tall. It has a crooked trunk and spreading branches, forming a broad crown. The leaves are pinnate, with three leaflets, and are shed during the winter months, rendering the tree leafless when it blooms in spring.",
    "Geographical distribution": "It is primarily found in the Indian Subcontinent, including India, Nepal, Sri Lanka, Bangladesh, and Pakistan. It also grows in Southeast Asia, covering areas in Myanmar, Thailand, Laos, Cambodia, and Vietnam. Its distribution reflects a preference for tropical and subtropical environments, thriving in a variety of habitats such as forests, grasslands, and alongside roads and riverbanks",
